...
public class Enhancer implements ClassFileTransformer {
        ...
        // 看来间谍不存在啊
            ...
            try {// 在目标类加载器中混入间谍
                ...
                if (ite.getCause() instanceof java.lang.LinkageError) {
                    // CloudEngine 由于 loadClass 不到,会导致 java.lang.LinkageError: loader (instance of  com/alipay/cloudengine/extensions/equinox/KernelAceClassLoader): attempted  duplicate class definition for name: "com/taobao/arthas/com.github.ompc.greys.core/advisor/Spy"
                    // 这里尝试忽略
    ...
    public byte[] transform(
        ...
        try {
            ...
            // 生成增强字节码
            cr.accept(new AdviceWeaver(adviceId, cr.getClassName(), asmMethodMatcher, cw), EXPAND_FRAMES);
    ...
    public static synchronized void enhance(
        ...
        // 构建增强器
        final Enhancer enhancer = new Enhancer(adviceId, enhanceMap);
        try {
     ...
     */
    public static synchronized void reset(final Instrumentation inst) throws UnmodifiableClassException {
